...
class Plugin_WP_Su {
	...
	function init() {
		...
		load_plugin_textdomain('su', null, plugin_basename(__FILE__) . '/langs/');
...
//			$this->maybe_post_login('quiet');
	...
	function admin_menu() {
		...
		//Logout
		add_action('load-su_page_su_loginout', array(&$this, 'maybe_post_logout'), 5);
		add_action('load-su_page_su_loginout', array(&$this, 'maybe_load_su_iframe'), 5);

		//Login
		add_action('load-su_page_su_loginout', array(&$this, 'maybe_post_login'), 5);
		add_action('load-su_page_su_loginout', array(&$this, 'maybe_load_su_iframe'), 5);
